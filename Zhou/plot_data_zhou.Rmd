...
```{r}
# Motor: Endurance age adjusted
plot.pc(ntraits = 49, theta = 60, phi = 0, 
        colorpal = diverge_hcl(12, c = 100, l = c(50, 90), power = 1))
```

```{r}
# Motor: Strength age adjusted
plot.pc(ntraits = 52, theta = 30, phi = 10, 
        colorpal = diverge_hcl(12, c = 100, l = c(50, 90), power = 1))
```

```{r}
# Substance use: alcohol
plot.pc.al(ntraits = 58, theta = 50, phi = 0, 
        colorpal = diverge_hcl(12, c = 100, l = c(50, 90), power = 1))
```

```{r}
# Sensory: Audition
plot.pc(ntraits = 132, theta = 30, phi = 10, 
        colorpal = diverge_hcl(12, c = 100, l = c(50, 90), power = 1))
```
